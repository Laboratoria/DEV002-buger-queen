  ...
  return (
    <div className={styles.bttn} id={id}>
      ...
      <div className={styles.signos}>
        <button className={styles.signo} onClick={Mas}>
          +
        </button>
        <p className={styles.text}>{cantidad}</p>
        <button className={styles.signo} onClick={Menos}>
          -
        </button>
      </div>

      <p className={styles.text}>S/.{precio}</p>
