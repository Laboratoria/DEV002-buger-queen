...
export function Formulario() {
  ...
  async function MostrarModal(e) {
    ...
    console.log(Lista);
    console.log(
      e.target.form.children[1].children[1].children[1].children[1].innerText
    );
    const nuevo = [...Lista];
    const nuevoQ = nuevo.map((item, i) => {
      let cantidad =
        e.target.form.children[1].children[i].children[1].children[1].innerText;
    ...
    <div className={styles.fondo}>
      <div className={styles.menu}>
        <div className={styles.headMenu}>
          <button
            className={selectedButton === 0 ? styles.color : styles.btn}
            onClick={cambioStyle}
          >
            Desayuno
          </button>
      ...
      <form className={styles.form}>
        <div id="head" className={styles.pedido}>
          ...
          <InputForm
            ...
            handleInputChange={handleInputChangePedido}
          />
          <InputForm
            value={Cliente}
